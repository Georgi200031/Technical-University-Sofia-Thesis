...
public:
    ...
    QAction *actionopen_settings_panel;
    ...
    void setupUi(QMainWindow *launchrayrenderClass)
    {
        ...
        actionopen_settings_panel = new QAction(launchrayrenderClass);
        actionopen_settings_panel->setObjectName("actionopen_settings_panel");
        ...
        RenderButton->addAction(actionopen_settings_panel);
    ...
    void retranslateUi(QMainWindow *launchrayrenderClass)
    {
        ...
        actionopen_settings_panel->setText(QCoreApplication::translate("launchrayrenderClass", "open settings panel", nullptr));
